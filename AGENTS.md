...
on a required key missing from the service's dev env files or either compose stack, and — before
any image builds — on one missing from the app's Fly env and secrets
