 ...
 * address gets an allocation action, and any public address it holds is a violation — reported,
 * never auto-released, since releasing a live address risks cutting inbound traffic mid-flight for
 * whatever still targets it. A `public` entry needs neither; its addresses are provisioned by
 * hand.
 */
