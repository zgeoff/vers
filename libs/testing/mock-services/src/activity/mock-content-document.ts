...
/**
 * Mirrors the migration's seeded v2 content document verbatim, so an MSW-backed client test
 * resolves the same content the real service seeds by default.
 */
export const MOCK_CONTENT_DOCUMENT: ContentDocument = {
  contentVersion: '2',
  encounter: {
    contentVersion: '2',
    archetypes: [
