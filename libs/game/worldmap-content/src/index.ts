export { BUNDLED_CONTENT_VERSION } from '@vers/content-version';
...
export type { DeriveWorldmapDescriptorInput } from './derive-worldmap-descriptor';
export { readScopeSecret } from './read-scope-secret';
