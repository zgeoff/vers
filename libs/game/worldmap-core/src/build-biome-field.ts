...
/**
 * Builds the biome texel grid a terrain-tint presentation samples, one `getBiome` draw per texel.
 ...
 * box with corner-anchored uvs interpolates. At `resolution` 1 a texel center lands exactly on
