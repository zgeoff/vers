 ...
 * wobbles. Banks drift between the far towers, mist rolls low across the gate end, vent plumes
 * rise off rooftop machinery, and the fog sea creeps in from a slowly turning wall encircling
 * the plaza. No plane writes depth;
...
import { DUSK_FOG, SMOKE_BLUE } from './palette';
