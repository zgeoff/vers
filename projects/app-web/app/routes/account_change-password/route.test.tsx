...
test('it shows validation errors for invalid form submission', async () => {
  ...
  await ctx.user.type(currentPasswordInput, 'current');
  await ctx.user.type(newPasswordInput, 'new');
  await ctx.user.type(confirmPasswordInput, 'different');
...
test('it handles a successful password change without 2FA', async () => {
  ...
  await ctx.user.type(currentPasswordInput, 'current_password');
  await ctx.user.type(newPasswordInput, 'new_password');
  await ctx.user.type(confirmPasswordInput, 'new_password');
  await ctx.user.click(submitButton);
...
test('it shows an error when the password change fails', async () => {
  ...
  await ctx.user.type(currentPasswordInput, 'wrong_password');
  await ctx.user.type(newPasswordInput, 'new_password');
  await ctx.user.type(confirmPasswordInput, 'new_password');
  await ctx.user.click(submitButton);
