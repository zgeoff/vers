...
/**
 * Drives a call with `useIdleWorkerHandle`'s mocked read set to `handle`, restoring the
 * no-worker default afterward — the only place a test may set what that mocked hook sees.
 */
