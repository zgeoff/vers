 ...
 * `setupTest`-style composites mint tokens from the private key. Bridges preload and test setup
 * through shared module state so both sides agree on the same keypair.
 */
