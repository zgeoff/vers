...
/**
 * Self-heals a chain's verified anchor when the claimed frontier's own `startChainIndex` sits
 ...
 * the chain row untouched, when the frontier isn't ahead or no such predecessor is found; the
