 ...
 * flight, and a replay machine that's already draining treats a redundant wake as a no-op. Never
 * throws — a delivery that exhausts its retries is a poke lost, not a caller failure, and the next
 * append's own call self-heals it.
 */
