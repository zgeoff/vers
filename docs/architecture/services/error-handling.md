...
| activity     | `PREDECESSOR_PENDING`  | 409    | A root mint's stamped predecessor activity has not reached the server yet; the client retries once its predecessor lands.                    | `{ activityID, appendedHead }`         |
