...
| activity     | `NODE_UNREACHABLE`     | 409    | Start's, or an `advanceActivity` root mint's, scope node resolves but sits outside the avatar's selectable set — neither the origin, a completed node, nor a neighbour of one                                                                                                                                                                                                     | —                                      |
