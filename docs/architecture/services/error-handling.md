...
| activity     | `PREDECESSOR_PENDING`  | 409    | Start or mint refused: the stamped predecessor activity has not reached the server yet; the client retries once its predecessor lands.       | —                                      |
