...
export class Notifier extends pulumi.CustomResource {
   ...
   */
  declare public readonly properties: pulumi.Output<outputs.NotifierProperties>;
  ...
  constructor(
    name: string,
    argsOrState?: NotifierArgs | NotifierState,
    opts?: pulumi.CustomResourceOptions,
  ) {
...
export interface NotifierState {
   ...
   * The properties of the notifier
   */
  properties?: pulumi.Input<inputs.NotifierProperties | undefined>;
}
